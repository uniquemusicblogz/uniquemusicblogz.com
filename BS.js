const mediaData = [
{
    ...
    },
    {
        ...
        artist: "Lady Gaga",
        cover: "a11.jpg",
        // You can also host Lady Gaga's track on OneDrive if desired;
        // Otherwise, leave it as the GitHub URL or update similarly.
    ...
    // Add other artists here using their respective OneDrive (or other host) URLs.
];
